...
export function adaptDoctorCase(apiCase = {}, fallback = {}) {
  ...
  return {
    ...
    submitted_on: firstValue(root, ["submitted_on", "appointment_date", "created_at", "date"], fallback.submitted_on || null),
